...
fun ImageView.loadImage(url: String) {
    try {
        Picasso.get().load(url).placeholder(R.drawable.bg_rectangle_gray_r5).into(this)
    } catch (e: Exception) {
        Picasso.get().load(R.drawable.bg_rectangle_gray_r5).into(this)
    }
}
